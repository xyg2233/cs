...
class Spider(Spider):
    ...
    def homeContent(self, filter):
        ...
        return {'class': [{'type_id': '电影', 'type_name': '电影'}, {'type_id': '连续剧', 'type_name': '连续剧'}, {'type_id': 1, 'type_name': '动漫'}, {'type_id': '短剧', 'type_name': '短剧'}, {'type_id': '综艺', 'type_name': '综艺'}, {'type_id': '纪录片', 'type_name': '纪录片'}]}
